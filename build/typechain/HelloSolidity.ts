...
export interface HelloSolidityInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "printGreeting" | "setGreeting"
  ): FunctionFragment;
...
export interface HelloSolidity extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HelloSolidityInterface;
